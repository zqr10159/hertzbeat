...
metrics_end_ms="$(($(date +%s) * 1000 + 60000))"
metrics_start_ms="$((metrics_end_ms - 3600000))"
...
metrics_console_path="/api/ingestion/otlp/metrics/console?start=${metrics_start_ms}&end=${metrics_end_ms}&entityId=${HERTZBEAT_ENTITY_ID}&entityType=${entity_type_q}&serviceName=${service_name_q}&serviceNamespace=${service_namespace_q}&environment=${environment_q}&query=${metric_query_q}"
