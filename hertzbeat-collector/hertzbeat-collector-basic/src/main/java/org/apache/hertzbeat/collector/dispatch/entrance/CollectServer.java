...
import org.apache.hertzbeat.collector.core.dispatch.CollectorInfoProperties;
import org.apache.hertzbeat.collector.core.dispatch.DispatchProperties;
import org.apache.hertzbeat.collector.core.dispatch.entrance.ClusterMessenger;
import org.apache.hertzbeat.collector.core.dispatch.entrance.internal.CollectJobService;
import org.apache.hertzbeat.collector.core.dispatch.entrance.processor.CollectCyclicDataProcessor;
import org.apache.hertzbeat.collector.core.dispatch.entrance.processor.CollectOneTimeDataProcessor;
import org.apache.hertzbeat.collector.core.dispatch.entrance.processor.DeleteCyclicTaskProcessor;
import org.apache.hertzbeat.collector.core.dispatch.entrance.processor.GoCloseProcessor;
import org.apache.hertzbeat.collector.core.dispatch.entrance.processor.GoOfflineProcessor;
import org.apache.hertzbeat.collector.core.dispatch.entrance.processor.GoOnlineProcessor;
import org.apache.hertzbeat.collector.core.dispatch.entrance.processor.HeartbeatProcessor;
...
@Slf4j
public class CollectServer implements CommandLineRunner, ClusterMessenger {
