...
package org.apache.hertzbeat.collector.core.dispatch.entrance.internal;
...
public class CollectJobService {
    ...
    private ClusterMessenger clusterMessenger;
    ...
    public CollectJobService(TimerDispatch timerDispatch, DispatchProperties properties, WorkerPool workerPool) {
        ...
        if (nettyProperties.getIdentity() != null && !nettyProperties.getIdentity().isEmpty()) {
    ...
    public void collectSyncOneTimeJobData(Job oneTimeJob) {
        workerPool.executeJob(() -> {
            ...
            ClusterMsg.Message message = ClusterMsg.Message.newBuilder()
                    ...
                    .build();
            this.clusterMessenger.sendMsg(message);
        });
    }
    ...
    public void setCollectServer(ClusterMessenger clusterMessenger) {
