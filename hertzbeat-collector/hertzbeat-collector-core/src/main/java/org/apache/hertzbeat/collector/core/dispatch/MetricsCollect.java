...
public class MetricsCollect implements Runnable, Comparable<MetricsCollect> {
     ...
     */
    protected MetricsTaskDispatch collectDataDispatch;
    /**
    ...
    public MetricsCollect(Metrics metrics, Timeout timeout,
                          MetricsTaskDispatch collectDataDispatch,
    ...
    private CollectRep.MetricsData validateResponse(CollectRep.MetricsData metricsData) {
        if (metricsData == null) {
